...
def create_map(in_dirs, out_dir, chain_length, mt_len, int_region, int_r, int_n, fix_tel, rep_e, gap_p, assembly, bin_size, nucleus_r, blocks, block_size, block_number):
    """
    ...
    sims = list(itertools.chain.from_iterable([list_URIs(d)[blocks:] for d in in_dirs.split(' ')]))
